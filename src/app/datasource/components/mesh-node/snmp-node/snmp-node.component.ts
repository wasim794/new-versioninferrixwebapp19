...
import {SnmpNodeDatasourceModel, SnmpNodePointLocatorModel} from '../../mesh-node';
import {SnmpNodeDatasourceService} from './service/snmp-node-datasource.service';
...
@Component({
  ...
  providers: [SnmpNodeDatasourceService, DataPointService, CommonService, DictionaryService],
  selector: 'app-snmp-node',
  templateUrl: './snmp-node.component.html'
})
export class SnmpNodeComponent extends  DataSourceBase implements OnInit {
  ...
  public snmpNodeDatasource:any = new SnmpNodeDatasourceModel();
  public _snmpNodePointLocator:any = new SnmpNodePointLocatorModel();
  ...
  constructor(public dictionaryService: DictionaryService,
              ...
              private _snmpNodeDatasource: SnmpNodeDatasourceService) {
    super();
  }
  ...
  override getDataSource(datasource: any, index: number, editForm: any) {
    this.snmpNodeDatasource = datasource;
    this.editPermission = this.snmpNodeDatasource.editPermission.split(',');
    this.setPermission = this.snmpNodeDatasource.editPermission.split(',');
  ...
  updateDatasource(){
    this.subs.add(this._snmpNodeDatasource.update(this.snmpNodeDatasource).subscribe(data=>{
      this.snmpNodeDatasource = data;
      this._commonService.notification(this.snmpNodeDatasource.name+' '+ this.updateMsg);
  ...
  editDataPoint(dataPoint: any) {
    ...
    this.subs.add(this._datapointService.getByXid(dataPointXid).subscribe(data => {
        ...
        this._snmpNodePointLocator = new SnmpNodePointLocatorModel(this.dataPointModel.pointLocator);
