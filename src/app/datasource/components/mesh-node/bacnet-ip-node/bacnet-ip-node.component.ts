...
import {BacnetIpNodeDatasourceModel, BacnetIpNodePointLocatorModel} from '../../mesh-node';
import {BacnetIpNodeDatasourceService} from './service/bacnet-ip-node-datasource.service';
...
@Component({
  ...
  providers: [BacnetIpNodeDatasourceService, DataPointService, CommonService, DictionaryService],

  selector: 'app-bacnet-ip-node',
  templateUrl: './bacnet-ip-node.component.html'
})
export class BacnetIpNodeComponent extends  DataSourceBase implements OnInit {
  ...
  public bacnetIpNodeDatasource:any = new BacnetIpNodeDatasourceModel();
  public _bacnetIpNodePointLocator:any = new BacnetIpNodePointLocatorModel();
  ...
  constructor(public dictionaryService: DictionaryService,
              ...
              private _bacnetIpNodeDatasource: BacnetIpNodeDatasourceService) {
    super();
  }
  ...
  editDataPoint(dataPoint: any) {
    ...
    this.subs.add(this._datapointService.getByXid(dataPointXid).subscribe(data => {
        ...
        this._bacnetIpNodePointLocator = new BacnetIpNodePointLocatorModel(this.dataPointModel.pointLocator);
