...
//   async async(websocketResponse, websocket): Promise<void> {
...
//   getEventDetectorByDataPoint(dataPointId) {
...
//   componentLoaded(componentType, eventDetectorModel) {
...
//   saveEventDetector() {
//     this.eventDetectorsArray.forEach(eventDetectorType => {
...
//         this.filteredArray = this.eventTableList.filter(h => h.name !== this.eventDetectorService.noChangeModel.sourceId);
//       }
...
//         this.eventTableList = [this.abstractEventDetector.body];
//         this.filteredArray = this.eventTableList.filter(h => h.name !== this.eventDetectorService.noUpdateModel.sourceId);
//       }
...
//         this.eventTableList = [this.abstractEventDetector.body];
//         this.filteredArray = this.eventTableList.filter(h => h.name !== this.eventDetectorService.multiStateModel.sourceId);
...
//         this.eventTableList = [this.abstractEventDetector.body];
//         this.filteredArray = this.eventTableList.filter(h => h.name !== this.eventDetectorService.pointChangeModel.sourceId);
...
//         this.eventTableList = [this.abstractEventDetector.body];
//         this.filteredArray = this.eventTableList.filter(h => h.name !== this.eventDetectorService.binaryStateModel.sourceId);
...
//         this.eventTableList = [this.abstractEventDetector.body];
//         this.filteredArray = this.eventTableList.filter(h => h.name !== this.eventDetectorService.stateChangeCountModel.sourceId);
...
//         this.eventTableList = [this.abstractEventDetector.body];
//         this.filteredArray = this.eventTableList.filter(h => h.name !== this.eventDetectorService.analogHighLimitModel.sourceId);
...
//         this.eventTableList = [this.abstractEventDetector.body];
//         this.filteredArray = this.eventTableList.filter(h => h.name !== this.eventDetectorService.analogLowLimitModel.sourceId);
...
//         this.eventTableList = [this.abstractEventDetector.body];
//         this.filteredArray = this.eventTableList.filter(h => h.name !== this.eventDetectorService.analogRangeModel.sourceId);
...
//         this.eventTableList = [this.abstractEventDetector.body];
//         this.filteredArray = this.eventTableList.filter(h => h.name !== this.eventDetectorService.negativeCusumModel.sourceId);
...
//         this.eventTableList = [this.abstractEventDetector.body];
//         this.filteredArray = this.eventTableList.filter(h => h.name !== this.eventDetectorService.positiveCusumModel.sourceId);
...
//         this.eventTableList = [this.abstractEventDetector.body];
//         this.filteredArray = this.eventTableList.filter(h => h.name !== this.eventDetectorService.alphaNumericRegexStateModel.sourceId);
...
//         this.eventTableList = [this.abstractEventDetector.body];
//         this.filteredArray = this.eventTableList.filter(h => h.name !== this.eventDetectorService.alphaNumericStateModel.sourceId);
...
//         this.eventTableList = [this.abstractEventDetector.body];
//         this.filteredArray = this.eventTableList.filter(h => h.name !== this.eventDetectorService.rateOfChangeModel.sourceId);
//       }
//       this.filteredArray.forEach(event => {
//         const uniqueArray = [...new Set(this.filteredArray.map(event => JSON.stringify(event)))].map(event => JSON.parse(event as any));
//         uniqueArray.forEach(event => {
//           // Check if event is not already present in this.dataSource and is not blank
//           if (event.name && !this.dataSource.some(data => data.name === event.name)) {
//             const availableElements = uniqueArray.filter(element => element.name && !this.dataSource.some(data => data.name === element.name));
