...
// import {BacnetSenderModel} from 'src/app/bacnet/shared/model/pages/bacnet-sender.model';
// import {BacnetSenderPointModel} from 'src/app/bacnet/shared/model/pages/bacnet-sender-point.model';
...
export class BacnetSenderComponent extends UnsubscribeOnDestroyAdapter  {
  ...
  // deviceChange(selectedOption, event: any): void {
  ...
  // private separateCallAlarmConfig(alarmData) {
  ...
  // private separateCallAlarmConfigEdits(alarmData) {
  ...
  //     if (response) {
  //       this.bacnetSenderModel.points = this.bacnetSenderModel.points.filter(item => item.dataPointXid !== datapoint.dataPointXid);
  //       this.subs.add(
